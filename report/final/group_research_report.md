...
![Trust in AI by Tech Comfort](../../outputs/figures/1.png)

![Which AI Constructs Score Highest and Lowest?](../../outputs/figures/16.png)

![Profile of Attitudes Toward AI Customer Service](../../outputs/figures/18.png)
...
![Correlation Matrix of AI Attitude Constructs](../../outputs/figures/9.png)

![Correlation Matrix: Trust, Convenience, Behavioral Intention](../../outputs/figures/19.png)

![Trust vs Behavioral Intention](../../outputs/figures/14.png)

![Convenience vs Behavioral Intention](../../outputs/figures/15.png)
...
![Trust in AI by Tech Comfort](../../outputs/figures/5.png)

![Preference for AI by Tech Comfort](../../outputs/figures/6.png)

![Distribution of Trust Scores by Tech Comfort](../../outputs/figures/3.png)

![Distribution of Preference Scores by Tech Comfort](../../outputs/figures/4.png)
...
![Trust in AI by AI Interaction Frequency](../../outputs/figures/7.png)

![Ease / Low Frustration by AI Interaction Frequency](../../outputs/figures/8.png)
...
![Regression Coefficients Predicting Behavioral Intention](../../outputs/figures/10.png)

![Interaction: Trust × Convenience](../../outputs/figures/13.png)

![Low Trust vs High Trust: Convenience & Behavioral Intention](../../outputs/figures/12.png)
...
[Click here to view the Python Notebook](../../analysis/notebooks/A3_analysis.pynb)
---
#### C. Additional charts not embedded in the main report (exported as .png and linked from the Results section).

![Behavioral Intention by Gender](../../outputs/figures/17.png)
